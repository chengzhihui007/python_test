...
def toutiao_save_and_preview(title, content, expand_link):
    ...
    driver = webdriver.Chrome(executable_path='H:/workspace/软件/chromedriver_win32/chromedriver', chrome_options=option)

    # 获取渲染的正文
    driver.get('F:/python_test/day10/headless/cases/paste.html')
